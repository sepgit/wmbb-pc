...
export default class Bdelair extends Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="bdel2">
                        ...
                        <div className="bdel4">
                            ...
                            <div className="bdel15">
                                ...
                                {
                                    this.props.bck.repldx.KGAi!=null?
                                        <p>{this.props.bck.repldx.freiCurr}   {this.props.bck.repldx.KGAi}/KG</p>:undefined
                                }
                            </div>
                            <div className="bdel8">
                                <ul>
