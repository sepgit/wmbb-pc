...
import Adsmid from './../../components/Adsertage/adsmid';
...
class Adsertage extends Component {
  render() {
    const { actions,text,shows,yssfw,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="advantagepage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Adsmid shows={shows} actions={actions} yssfw={yssfw} text={text}/>
      </div>
    );
  }
}
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      getyssfbr:getyssfbr,
      getyssreov:getyssreov,
      getyssusers:getyssusers,
      postyssnew:postyssnew,
      getyssjtfww:getyssjtfww,
      getysslistc:getysslistc,
      getysslist:getysslist,
      getysslistgd:getysslistgd,
      getyssxq:getyssxq,
      putyssztbg:putyssztbg,
...
Adsertage=connect(mapStateToProps,mapDispatchToProps)(Adsertage);
module.exports = Adsertage;