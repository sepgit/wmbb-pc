...
export default class Bchair extends Component {
  constructor(props) {
    super(props);
  ...
  handfs(){
    ...
    if(freiCurr==''||KGAi==''||expiDate==null||carr==''||sailTime==''||closTime==''||sailDays==''){
          ...
          <div className="bdel2">
            ...
            <div className="bdel4">
              ...
              <div className="bdel15">
                <span className="bdel15sp">空运价</span>
                <Select
                  value={this.state.kyjbz}
                  style={{ width: 60 ,marginLeft:10}}
                  className="delsel"
                  onChange={(v)=>{return this.setState({kyjbz:v})}}
                >
                  <Option key='1' value="USD">USD</Option>
                  <Option key='2' value="CNY">CNY</Option>
                </Select>:
                <Input
                  value={this.state.kyjsz}
                  style={{width:115,height:23}}
                  className="delinp"
                  onChange={(e)=>{return this.setState({kyjsz:e.target.value})}}
                />
                /KG
            ...
            <div className="bdel5">
              <div className="bdel17">
                <ul>
                  ...
                  <li>
                    <span>询盘人</span>
                    <p>{this.props.bck.enqudx.mngrName!=''&&this.props.bck.enqudx.mngrName!=null?this.props.bck.enqudx.mngrName:this.props.bck.enqudx.enquerName}</p>
                  </li>
                  <li>
                    <span>完货日期</span>
              ...
              <div className="bdel18">
                <span>承运商</span>
                <p>{this.props.bck.carrsary}</p>
              </div>
              <div className="bdel19">
                <span>更多要求</span>
