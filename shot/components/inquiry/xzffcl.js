...
export default class Xzffcl extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            NOR40:this.props.getdetil.enqu.NOR40,
            HQ40:this.props.getdetil.enqu.HQ40,
            HQ45:this.props.getdetil.enqu.HQ45,
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.getxaddfcl(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,GP20,GP20Wate,GP40,NOR40,HQ40,HQ45,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
