...
export function postcwbfb(userName,token,serv,carr,depaPort,destPort,curr,resPref,reqPref,closTime,sailTime,expiTime,lastShutTime,GP20,GP20Fee,GP20Cos,GP40,GP40Fee,GP40Cos,NOR40,NOR40Fee,NOR40Cos,HQ40,HQ40Fee,HQ40Cos,HQ45,HQ45Fee,HQ45Cos,currCos,showname,voyage,trans,label,delayhours){
  return function(dispatch) {
    fetch(HTTPED+'api/cabDisps/',{
      ...
      +"&HQ45="+HQ45+"&HQ45Fee="+HQ45Fee+"&HQ45Cos="+HQ45Cos+"&currCos="+currCos+"&showname="+showname+"&voyage="+voyage+"&trans="+trans+'&label=' +label+'&delayhours='+delayhours
    }).then(function(res){
      if(res.ok){
        res.json().then(function(date){
          if(!date.err){
...
export function postcwbfbdg(userName,token,serv,carr,depaPort,destPort,curr,resPref,reqPref,closTime,sailTime,expiTime,lastShutTime,GP20,GP20Fee,GP20Cos,GP40,GP40Fee,GP40Cos,HQ40,HQ40Fee,HQ40Cos,unno,clas,currCos,showname,voyage,trans,label,delayhours){
  return function(dispatch) {
    fetch(HTTPED+'api/cabDisps/',{
      method: "post",
      headers: {
      ...
      +"&GP20="+GP20+"&GP20Fee="+GP20Fee+"&GP20Cos="+GP20Cos
      +"&GP40="+GP40+"&GP40Fee="+GP40Fee+"&GP40Cos="+GP40Cos
      +"&HQ40="+HQ40+"&HQ40Fee="+HQ40Fee+"&HQ40Cos="+HQ40Cos+"&clas="+clas+"&unno="+unno+"&currCos="+currCos+"&showname="+showname+"&voyage="+voyage+"&trans="+trans+"&label="+label+"&delayhours="+delayhours
    }).then(function(res){
      if(res.ok){
        res.json().then(function(date){
          if(!date.err){
...
export function postcwbfbhg(userName,token,serv,carr,depaPort,destPort,curr,resPref,reqPref,closTime,sailTime,expiTime,lastShutTime,GP20,GP20Fee,GP20Cos,GP40,GP40Fee,GP40Cos,HQ40,HQ40Fee,HQ40Cos,HQ45,HQ45Fee,HQ45Cos,currCos,showname,voyage,trans,label,delayhours){
  return function(dispatch) {
    fetch(HTTPED+'api/cabDisps/',{
      method: "post",
      headers: {
...
export function postcwbfbfr(userName,token,serv,carr,depaPort,destPort,curr,resPref,reqPref,closTime,sailTime,expiTime,lastShutTime,FR20,FR20Fee,FR20Cos,FR40,FR40Fee,FR40Cos,leng,widt,high,currCos,showname,voyage,trans,label,delayhours){
  return function(dispatch) {
    fetch(HTTPED+'api/cabDisps/',{
      method: "post",
      headers: {
      ...
      +"&leng="+leng+"&widt="+widt+"&high="+high+"&currCos="+currCos+"&showname="+showname+"&voyage="+voyage+"&trans="+trans+"&label="+label+"&delayhours="+delayhours
    }).then(function(res){
      if(res.ok){
        res.json().then(function(date){
          if(!date.err){
...
export function postcwbfbot(userName,token,serv,carr,depaPort,destPort,curr,resPref,reqPref,closTime,sailTime,expiTime,lastShutTime,RF20,RF20Fee,RF20Cos,RF40,RF40Fee,RF40Cos,leng,widt,high,currCos,showname,voyage,trans,label,delayhours){
  return function(dispatch) {
    fetch(HTTPED+'api/cabDisps/',{
      method: "post",
      headers: {
