...
export default class Cabcwn extends Component {
  constructor(props) {
    super(props);
  }
  render() {
        ...
        <div className="xnew32">
          <ul>
            ...
            {/*<li>
             <h4>车队安排</h4>
             <Select
             value={this.props.cdap}
             style={{ width: 150}}
             className="xaddddr"
             onChange={this.props.handcdap}
             >
             <Option key='1' value="求舱方车队安排">求舱方车队安排</Option>
             <Option key='2' value="供舱方车队安排">供舱方车队安排</Option>
             </Select>
             </li>
             <li> </li>*/}
            <li>
