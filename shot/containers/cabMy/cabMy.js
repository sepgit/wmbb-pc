...
import CabMymid from './../../components/cabMy/cabMymid';
import {
  getyg,
  getqx,
  gethgerxx,
...
class cabMy extends Component {
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabrnew,cabmynew,cabnew} = this.props;
    return (
      <div className="cabpage">
        ...
        <NewL actions={actions}
              ...
              cabmynew={cabmynew}
        />
        <CabMymid actions={actions} text={text} cabmynew={cabmynew}/>
      </div>
    );
  }
}
