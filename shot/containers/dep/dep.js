...
import Depmid from './../../components/dep/depmid';
...
class Dep extends Component {
  render() {
    const { actions,text,depl,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="deppage">
        ...
        <NewL actions={actions}
              ...
              cabmynew={cabmynew}
        />
        <Depmid actions={actions} text={text} depl={depl}/>
      </div>
    );
  }
}
...
Dep=connect(mapStateToProps,mapDispatchToProps)(Dep);
module.exports = Dep;