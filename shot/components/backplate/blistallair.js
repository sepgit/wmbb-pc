...
import Bdelair from './bdelair';
import Bchair from './bchair';
import Bzfair from './bzfair';
...
export default class Blistallair extends Component {
  constructor(props) {
    super(props);
      ...
      <li className="bplt">
        ...
        <div className="bplt2">
          ...
          <div className="bplte">
            ...
            {
              this.props.rows.KGAi != null&&this.props.rows.KGAi != 0 ?
                <div className="bpltediv">{this.props.rows.KGAi}/KG</div>:undefined
            }
          </div>
        </div>
        <div className="bplt3">
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.props.shows.texthp&&this.props.shows.keyshp==this.props.keys?
              <Bdelair handchshow={this.handchshow}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.isch&&this.state.keysd==this.props.keys?
              <Bchair handchclose={this.handchclose}
                      actions={this.props.actions}
                      cabrnew={this.props.cabrnew}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.iszf&&this.state.keysd==this.props.keys?
              <Bzfair handzfclose={this.handzfclose}
                      text={this.props.text}
