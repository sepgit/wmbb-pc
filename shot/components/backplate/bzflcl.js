...
import Cabcwn from './../inquiry/cabcwn';
...
export default class Bzflcl extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            packType:this.props.bck.enqudx.packType,
            recr:this.props.bck.enqudx.recr,
            wate:this.props.bck.enqudx.wate,
            bulk:this.props.bck.enqudx.bulk,
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.gethpxaddlcl(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,packType,recr,wate,bulk,itemName,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr,teamAnge);
    ...
    render() {
        ...
        if(this.state.ptgys=='1'){
            cabFee=num["RTMiLCL"]*this.state.wate;
        }else{
            cabFee=0;
        }
        return (
