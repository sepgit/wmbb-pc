...
import Blmid from './../../components/blacklist/blmid';
...
class Blacklist extends Component {
  render() {
    const { actions,text,blck,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="blacklistpage">
          ...
          />
        {
          text.user.userVip==1?<Blmid actions={actions} text={text} blck={blck} />:undefined
        }
      </div>
    );
  }
