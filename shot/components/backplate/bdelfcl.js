...
export default class Bdelfcl extends Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="bdel2">
                        ...
                        <div className="bdel4">
                            ...
                            <div className="bdel7">
                                ...
                                <ul>
                                    {
                                        this.props.bck.repldx.GP20 != null && this.props.bck.repldx.GP20 != 0 ?
                                            <li>
                                                <span className="bdel7sp">20GP</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.GP20}</p>
                                            </li> : undefined
                                    }
                                    {
                                        this.props.bck.repldx.NOR40 != null && this.props.bck.repldx.NOR40 != 0 ?
                                            <li>
                                                <span className="bdel7sp">40NOR</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.NOR40}</p>
                                            </li> : undefined
                                    }
                                    {
                                        this.props.bck.repldx.GP40 != null && this.props.bck.repldx.GP40 != 0 ?
                                            <li>
                                                <span className="bdel7sp">40GP</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.GP40}</p>
                                            </li> : undefined
                                    }
                                    {
                                        this.props.bck.repldx.HQ45 != null && this.props.bck.repldx.HQ45 != 0 ?
                                            <li>
                                                <span className="bdel7sp">45HQ</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.HQ45}</p>
                                            </li> : undefined
                                    }
                                    {
                                        this.props.bck.repldx.HQ40 != null && this.props.bck.repldx.HQ40 != 0 ?
                                            <li>
                                                <span className="bdel7sp">40HQ</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.HQ40}</p>
                                            </li> : undefined
                                    }
                                </ul>
                            </div>
                        ...
                        <div className="getxp10bg">
                            <div className="getxp10s">
                                <div className="getxp11">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;9.贵方求舱方选择“货物进仓”所做的舱位保函时，贵方或者贵方求舱方必须使用平台指定的仓库。费用由贵方或者贵方求舱方与平台结算。<br /><br />
