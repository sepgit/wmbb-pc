                ...
                <li>
                  <h5>开航时间:</h5>
                  {
                    this.props.cabmynew.cabDispdetail.sailTime==null?<span></span>:
                      <span>{moment(this.props.cabmynew.cabDispdetail.sailTime).format('YYYY-MM-DD')}</span>
                  }
                </li>
                <li>
                  <h5>内陆方式:</h5>
                ...
                <li>
                  <h5>运价有效期:</h5>
                  {
                    this.props.cabmynew.cabDispdetail.expiTime == null ? '' :
                      <span>{moment(this.props.cabmynew.cabDispdetail.expiTime).format('YYYY-MM-DD')}</span>
                  }
                </li>
              </ul>
            </div>
              ...
              <div className="cab52">
                {
                  this.props.cabmynew.cabDispdetail.GP20?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.GP20Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.GP40?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.GP40Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.NOR40?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.NOR40Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.HQ40?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.HQ40Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.HQ45?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.HQ45Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.FR20?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.FR20Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.FR40?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.FR40Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.RF20?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.RF20Cos}</p>
                      </div>
                    </div>:undefined
                }
                {
                  this.props.cabmynew.cabDispdetail.RF40?
                    <div className="cab53">
                      ...
                      <div className="cab54">
                        <span>总运价:</span>
                        <p>{this.props.cabmynew.cabDispdetail.curr==1?'¥':'$'} {this.props.cabmynew.cabDispdetail.RF40Cos}</p>
                      </div>
                    </div>:undefined
                }
              </div>
