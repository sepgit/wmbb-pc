...
export default class Cabno extends Component {
    constructor(props) {
        super(props);
    ...
    hanqryi() {
        ...
        //不确认自己履约
        this.props.actions.getqrzjlv(this.state.userName,this.state.token,this.props.cabEnqu,2,yi,this.props.cabRepl);
        this.props.handnoc();
    }
    render() {
        return (
