...
export default class Xphplistsreefer extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    let RF20,RF40,strRF20,strRF40;
    if(this.props.rows.RF20!=null&&this.props.rows.RF20!=0){
      RF20=this.props.rows.RF20;
      strRF20='20RF';
    }
    if(this.props.rows.RF40!=null&&this.props.rows.RF40!=0){
      RF40=this.props.rows.RF40;
      strRF40='40RF';
    }
    let styl='';
