...
export default class Raddzx extends Component {
    constructor(props) {
        ...
        this.state={
            ports:this.props.replays.zxdetl.portName,
            sendTo:[],
            ccto:[],
            mngr:undefined,
            servOpti:this.props.replays.zxdetl.servOptiName,
            consMemo:this.props.replays.zxdetl.consMemo,
            match:matchs,
    ...
    handkan(v){
        ...
        this.props.actions.gethfsendto(this.state.userName,this.state.token,this.props.replays.zxdetl.serv,v);//获取收件人
    }
    componentDidMount(){
        this.props.actions.gethfportsf(this.state.userName,this.state.token,this.props.replays.zxdetl.serv);//获取最近口岸
        this.props.actions.gethfjtser(this.state.userName,this.state.token,this.props.replays.zxdetl.serv);//获取服务类型
        this.props.actions.gethfzjkan(this.state.userName,this.state.token,this.props.replays.zxdetl.serv);//获取最近口岸
        this.props.actions.gethfsendto(this.state.userName,this.state.token,this.props.replays.zxdetl.serv,this.props.replays.zxdetl.port);//获取收件人
    }
    handlefs(){
        let userName=this.state.userName;
        let userid=this.state.userid;
        let token=this.state.token;
        let serv=this.props.replays.zxdetl.serv;
        let servOpti=this.state.servOpti==this.props.replays.zxdetl.servOptiName?this.props.replays.zxdetl.servOpti:this.state.servOpti;
        let port=this.state.ports==this.props.replays.zxdetl.portName?this.props.replays.zxdetl.port:this.state.ports;
        ...
        if (servOpti == '' || port == '') {
            ...
            this.props.actions.gethfaddnew(userid,userName,token,serv,servOpti,port,consMemo,sendTo,ccto,match,mngr);
            this.props.handzfc();
        }
    }
    handlecz(){
        ...
        return (
            <div className="zxnewdiv">
                <div className="zxnd">
                    ...
                    <div className="zxnd1">
                        <div className="zxnd2">
                            <span>新增咨询-{this.props.replays.zxdetl.servName}</span>
                            <ul>
                                ...
                                <li className="zxnd8">
                                    <div className="zxnd4">
                                        ...
                                        <Select showSearch
                                            ...
                                            >
                                            {
                                                this.props.replays.serJser.map(s => <Option key={s.servOpti}>{s.name}</Option>)
                                            }
                                        </Select>
                                    </div>
                                    <div className="zxnd4">
                                        ...
                                        <Zselectopzf
                                            ref='hfqyds'
                                            vas={this.props.replays.zxdetl.portName}
                                            handleChangev={this.handkan}
                                            className="Z-select2"
                                            opizj={this.props.replays.portszj}
                                            opi={this.props.replays.hfportsf}
                                            />
                                    </div>
                                </li>
                                <li className="zxnd8">
                                        ...
                                        this.state.comp != 0 ?
                                            <div className="zxnd4">
                                                ...
                                                <Select showSearch
                                                    ...
                                                    >
                                                    {
                                                        this.props.replays.hfwtuo.map((item, index)=> {
                    ...
                    {
                        this.state.isjs?
                            <Hsjr actions={this.props.actions}
                    ...
                    {
                        this.state.icss?
                            <Hcsr actions={this.props.actions}
                                  replays={this.props.replays}
                                  hcsrc={this.hcsrc}
                                  hcsrq={this.hcsrq}
