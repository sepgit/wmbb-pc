...
import Mxqmid from './../../components/meetxqlist/mxqmid';
...
class Meetxqlist extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,meetlxq,cabnew,cabmynew} = this.props;
    return (
      <div className="mtxqpage">
          <Gotop />
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      getkansp:getkansp,
      getmeetlxq:getmeetlxq,
      getmeetlxqz:getmeetlxqz,
      getmeetlxqt:getmeetlxqt,
      getgyye:getgyye,
      getgysfw:getgysfw,
      getgysl:getgysl,
      getckfy:getckfy,
...
Meetxqlist=connect(mapStateToProps,mapDispatchToProps)(Meetxqlist);
module.exports = Meetxqlist;