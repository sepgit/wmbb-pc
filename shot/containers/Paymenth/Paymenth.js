...
import Pamidh from './../../components/Paymenth/pamidh';
...
class Paymenth extends Component {
  render() {
    const { actions,text,shows,paysh,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="paypage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Pamidh paysh={paysh} shows={shows} text={text} actions={actions}/>
      </div>
    );
  }
}
...
Paymenth=connect(mapStateToProps,mapDispatchToProps)(Paymenth);
module.exports = Paymenth;