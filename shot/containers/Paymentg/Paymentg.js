...
import Pamid from './../../components/Paymentg/pamid';
...
class Paymentg extends Component {
  render() {
    const { actions,text,pays,shows,getdetil,getnewlist,zxinfo,rsup,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="paypage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Pamid pays={pays} text={text} shows={shows} actions={actions}/>
      </div>
    );
  }
}
...
Paymentg=connect(mapStateToProps,mapDispatchToProps)(Paymentg);
module.exports = Paymentg;