                    ...
                    <div className="cab120">
                        <ul>
                            ...
                            <li>
                                <h5>内陆费用:</h5>                    
                                {
                                    this.props.cabrnew.cabReplr.cabFee != null?
                                        this.props.cabrnew.cabReplr.cabFee != 0?
                                        <span>{this.props.cabrnew.cabReplr.curr== '1' ? '¥' : '$'} {this.props.cabrnew.cabReplr.cabFee}</span>:undefined
                                    :undefined
                                }
                            </li>
                            {/*<li>
                            ...
                            <li className="cab140-label">
                                <h5>备注:</h5>
                                <span>{this.props.cabrnew.cabReplr.replMemo}</span>
                            </li>
                            {/* <li>
                                <h5>备注:</h5>
                                <span className="overflowH">{this.props.cabrnew.cabReplr.replMemo}</span>
                            </li> */}
                        </ul>
                    </div>
                        ...
                        <div className="cab134">
                          {
                            this.props.cabrnew.cabReplr.GP20?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.GP20F)*parseFloat(this.props.cabrnew.cabReplr.GP20)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.GP40?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.GP40F)*parseFloat(this.props.cabrnew.cabReplr.GP40)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.NOR40?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'}{parseFloat(this.props.cabrnew.cabReplr.NOR40F)*parseFloat(this.props.cabrnew.cabReplr.NOR40)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.HQ40?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.HQ40F)*parseFloat(this.props.cabrnew.cabReplr.HQ40)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.HQ45?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.HQ45F)*parseFloat(this.props.cabrnew.cabReplr.HQ45)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.FR20?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'}{parseFloat(this.props.cabrnew.cabReplr.FR20F)*parseFloat(this.props.cabrnew.cabReplr.FR20)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.FR40?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.FR40F)*parseFloat(this.props.cabrnew.cabReplr.FR40)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} </p>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.RF20?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'} {parseFloat(this.props.cabrnew.cabReplr.RF20F)*parseFloat(this.props.cabrnew.cabReplr.RF20)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                          ...
                          }
                          {
                            this.props.cabrnew.cabReplr.RF40?
                              <div className="cab53">
                                  ...
                                  <div className="cab54">
                                      <span>总运价:</span>
                                      <p>{this.props.cabrnew.cabReplr.freiCurr=="USD"?'$':'¥'}  {parseFloat(this.props.cabrnew.cabReplr.RF40F)*parseFloat(this.props.cabrnew.cabReplr.RF40)}</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                          ...
                          {
                            this.props.cabrnew.cabReplr.RTMi?
                              <div className="cab53">
                                  <div className="cab54">
                                      <span>重量</span>
                                      <p>{this.props.cabrnew.cabReplr.wate}KG</p>
                                  </div>
                                  <div className="cab54">
                                      <span>体积</span>
                                      <p>{this.props.cabrnew.cabReplr.bulk}CBM</p>
                                  </div>
                                  <div className="cab54">
                                      <span>总定金:</span>
                                      <p>{this.props.cabrnew.cabReplr.curr==1?'¥':'$'} {this.props.cabrnew.cabReplr.RF40Fee}</p>
