...
export default class Bdelreefer extends Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="bdel2">
                        ...
                        <div className="bdel4">
                            ...
                            <div className="bdel20">
                                ...
                                <ul>
                                    {
                                        this.props.bck.repldx.RF20 != null &&this.props.bck.repldx.RF20!=0?
                                            <li>
                                                <span className="bdel20sp">20RF</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.RF20}</p>
                                            </li>:undefined
                                    }
                                    {
                                        this.props.bck.repldx.RF40 != null &&this.props.bck.repldx.RF40!=0 ?
                                            <li>
                                                <span className="bdel20sp">40RF</span>
                                                <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.RF40}</p>
                                            </li>:undefined
                                    }
                                </ul>
                            </div>
