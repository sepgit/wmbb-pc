...
import Cabrmid from './../../components/cabr/cabrmid';
...
class Cabr extends Component {
  render() {
    const { actions,text,cabrnew,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="cabpage">
        ...
        <NewL actions={actions}
              ...
              cabmynew={cabmynew}
        />
        <Cabrmid actions={actions} text={text} cabrnew={cabrnew}/>
      </div>
    );
  }
}
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      getgcgd:getgcgd,
      gethqxqr:gethqxqr,
      getqrzjlvr:getqrzjlvr,
      getqrdflvr:getqrdflvr,
      getsclvzmr:getsclvzmr,
...
Cabr=connect(mapStateToProps,mapDispatchToProps)(Cabr);
module.exports = Cabr;