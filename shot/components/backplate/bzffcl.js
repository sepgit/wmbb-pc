...
export default class Bzffcl extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            GP20:this.props.bck.enqudx.GP20,
            GP20Wate:this.props.bck.enqudx.GP20Wate,
            GP40:this.props.bck.enqudx.GP40,
            NOR40:this.props.bck.enqudx.NOR40,
            HQ40:this.props.bck.enqudx.HQ40,
            HQ45:this.props.bck.enqudx.HQ45,
    ...
    handlesend(){
        ...
        let NOR40 = this.state.NOR40==''?0:this.state.NOR40;
        let HQ40 = this.state.HQ40==''?0:this.state.HQ40;
        let HQ45 = this.state.HQ45==''?0:this.state.HQ45;
        ...
        let cabFee=num["20GP"]*GP20+num["40GP"]*GP40+num["40NOR"]*NOR40+num["40HQ"]*HQ40+num["45HQ"]*HQ45;
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.gethpxaddfcl(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,GP20,GP20Wate,GP40,NOR40,HQ40,HQ45,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
    ...
    render() {
        ...
        if(this.state.ptgys=='1'){
            cabFee=num["20GP"]*this.state.GP20+num["40GP"]*this.state.GP40+num["40NOR"]*this.state.NOR40+num["40HQ"]*this.state.HQ40+num["45HQ"]*this.state.HQ45;
        }else{
            cabFee=0;
        }
        return (
