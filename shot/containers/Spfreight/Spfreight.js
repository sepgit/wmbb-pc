...
import Spmid from './../../components/Spfreight/spmid';
...
class Spfreight extends Component {
  render() {
    const { actions,text,shows,yssp,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,cabnew,cabmynew} = this.props;
    return (
      <div className="spfreightmasg">
          <Gotop />
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Spmid actions={actions} text={text} shows={shows} yssp={yssp} />
      </div>
    );
  }
}
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      getysplistc:getysplistc,
      getysplist:getysplist,
      getysplistgd:getysplistgd,
      getyspxq:getyspxq,
      putyspztbg:putyspztbg,
      getysspzj:getysspzj,
      putysbzsp:putysbzsp,
...
Spfreight=connect(mapStateToProps,mapDispatchToProps)(Spfreight);
module.exports = Spfreight;