...
import Smid from './../../components/Supplier/smid';
...
class Supplier extends Component {
  render() {
    const { actions,text,rsup,shows,getdetil,getnewlist,zxinfo,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="supplierpage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Smid actions={actions} rsup={rsup} shows={shows}/>
      </div>
    );
  }
}
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      getgyslistc:getgyslistc,
      getgyslist:getgyslist,
      getgyslistgd:getgyslistgd,
      gysshow:gysshow,
      delgysdel:delgysdel,
      getgysdet:getgysdet,
      putgysupd:putgysupd,
      getgysportszj:getgysportszj,
      getkansu:getkansu,
      getusermh:getusermh,
      getuserlb:getuserlb,
      getzjusr:getzjusr,
