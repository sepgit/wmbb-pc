...
import Bdelreefer from './bdelreefer';
import Bchreefer from './bchreefer';
import Bzfreefer from './bzfreefer';
...
export default class Blistallreefer extends Component {
  constructor(props) {
    super(props);
      ...
      <li className="bplt">
        ...
        <div className="bplt2">
          ...
          <div className="bplte">
            ...
            {
              this.props.rows.RF20 != null&&this.props.rows.RF20 != 0 ?
                <div className="bplte1">
                  <span>{this.props.rows.RF20}</span>
                  <img src={require('../../src/image/20rf.png')}/>
                </div>:undefined
            }
            {
              this.props.rows.RF40 != null&&this.props.rows.RF40 != 0 ?
                <div className="bplte2">
                  <span>{this.props.rows.RF40}</span>
                  <img src={require('../../src/image/40rf.png')}/>
                </div>:undefined
            }
          </div>
        </div>
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.props.shows.texthp&&this.props.shows.keyshp==this.props.keys?
              <Bdelreefer handchshow={this.handchshow}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.isch&&this.state.keysd==this.props.keys?
              <Bchreefer handchclose={this.handchclose}
                         actions={this.props.actions}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.iszf&&this.state.keysd==this.props.keys?
              <Bzfreefer handzfclose={this.handzfclose}
                         text={this.props.text}
