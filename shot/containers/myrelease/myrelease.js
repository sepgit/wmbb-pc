...
import Myrel from './../../components/tickets/myrel'
import {
  getyg,
  getqx,
  gethgerxx,
...
class cabMy extends Component {
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabrnew,cabmynew,cabnew,tktnew,owntkts,myrls} = this.props;
    return (
      <div className="cabpage">
        ...
        <NewL actions={actions}
              ...
              owntkts = {owntkts}
        />
        <Myrel actions={actions} text={text} tktnew={tktnew} owntkts = {owntkts}  myrls={myrls}/>
      </div>
    );
  }
}
