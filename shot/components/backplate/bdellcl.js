...
export default class Bdellcl extends Component {
    constructor(props) {
        super(props);
                        ...
                        <div className="bdel4">
                            ...
                            <div className="bdel15">
                                <span className="bdel15sp">运价</span>
                                {
                                    ...
                                    <p>{this.props.bck.repldx.freiCurr}:{this.props.bck.repldx.RTMi}/RT</p>:undefined
                                }
                            </div>
                            <div className="bdel8">
                                <ul>
                        ...
                        <div className="bdel5">
                            ...
                            <div className="bdel16">
                                <ul>
                                    ...
                                    <li>
                                        <span>收货人</span>
                                        <p>{this.props.bck.enqudx.recr==1?'直客':'同行'}</p>
                                    </li>
                                    <li>
