...
export default class Xzfreefer extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            RF20:this.props.getdetil.enqu.RF20,
            RF20Wate:this.props.getdetil.enqu.RF20Wate,
            RF40:this.props.getdetil.enqu.RF40,
            RF40Wate:this.props.getdetil.enqu.RF40Wate,
            shpr:this.props.getdetil.enqu.shpr,
            temp:this.props.getdetil.enqu.temp,
    ...
    handlesend(){
        ...
        if(depaPort==''||destPort==''){
            ...
            this.props.actions.getxaddreefer(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,RF20,RF20Wate,RF40,RF40Wate,shpr,temp,itemName,expiDate,enquMemo);
