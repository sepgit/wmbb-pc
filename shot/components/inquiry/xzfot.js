...
export default class Xzfot extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            OT20:this.props.getdetil.enqu.FR20,
            OT20Wate:this.props.getdetil.enqu.FR20Wate,
            OT40:this.props.getdetil.enqu.FR40,
            OT40Wate:this.props.getdetil.enqu.FR40Wate,
    ...
    handlesend(){
        ...
        let OT20 = this.state.OT20==''?0:this.state.OT20;
        let OT20Wate = this.state.OT20Wate;
        let OT40 = this.state.OT40==''?0:this.state.OT40;
        let OT40Wate = this.state.OT40Wate;
        ...
        let cabFee=num["20OT"]*OT20+num["40OT"]*OT40;
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.getxaddot(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,OT20,OT20Wate,OT40,OT40Wate,leng,widt,high,itemName,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
    ...
    render() {
        ...
        if(this.state.ptgys=='1'){
            cabFee=num["20OT"]*this.state.OT20+num["40OT"]*this.state.OT40;
        }else{
            cabFee=0;
        }
        return (
                    ...
                    <div className="xnew2">
                        ...
                        <div className="xnew4">
                            <ul>
                                ...
                                <li className="xnew15">
                                    <span className="xspan5">20OT</span>
                                    <ul className="xnew10">
                                        <li>
                                            <Input
                                                value={this.state.OT20}
                                                placeholder="个数"
                                                className="xsmaills"
                                                onChange={(e)=>{return this.setState({OT20:e.target.value})}}
                                                />/
                                            <Input
                                                value={this.state.OT20Wate}
                                                placeholder="总重"
                                                className="xsmaills"
                                                onChange={(e)=>{return this.setState({OT20Wate:e.target.value})}}
                                                />T
                                        </li>
                                        <li>
                                            <span>40FR</span>
                                            <Input
                                                value={this.state.OT40}
                                                placeholder="个数"
                                                className="xsmaills"
                                                onChange={(e)=>{return this.setState({OT40:e.target.value})}}
                                                />/
                                            <Input
                                                value={this.state.OT40Wate}
                                                placeholder="总重"
                                                className="xsmaills"
                                                onChange={(e)=>{return this.setState({OT40Wate:e.target.value})}}
                                                />T
                                        </li>
                                        <li>
                                            <span>品名</span>
