...
import Cabrgmid from './../../components/cabrg/cabrgmid';
...
class Cabrg extends Component {
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabrgnew,cabmynew} = this.props;
    return (
      <div className="cabpage">
        ...
        <NewL actions={actions}
              ...
              cabmynew={cabmynew}
        />
        <Cabrgmid actions={actions} text={text} cabrgnew={cabrgnew}/>
      </div>
    );
  }
}
...
Cabrg=connect(mapStateToProps,mapDispatchToProps)(Cabrg);
module.exports = Cabrg;