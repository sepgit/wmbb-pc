...
import Cabgmid from './../../components/cabg/cabgmid';
    ...
    return (
      <div className="cabpage">
        ...
        <NewL actions={actions}
              ...
              cabmynew={cabmynew}
        />
        <Cabgmid actions={actions} text={text} cabnew={cabnew} cabgnew={cabgnew}/>
      </div>
    );
  }
}
...
Cabg=connect(mapStateToProps,mapDispatchToProps)(Cabg);
module.exports = Cabg;