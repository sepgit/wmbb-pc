...
import Medmid from './../../components/meetedit/medmid';
...
class Meetedit extends Component {
  constructor(props) {
    super(props);
  }
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,mbdit,cabnew,cabmynew} = this.props;
    return (
...
Meetedit=connect(mapStateToProps,mapDispatchToProps)(Meetedit);
module.exports = Meetedit;