...
export default class Xzffr extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            FR20:this.props.getdetil.enqu.FR20,
            FR20Wate:this.props.getdetil.enqu.FR20Wate,
            FR40:this.props.getdetil.enqu.FR40,
            FR40Wate:this.props.getdetil.enqu.FR40Wate,
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.getxaddfr(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,FR20,FR20Wate,FR40,FR40Wate,leng,widt,high,itemName,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
