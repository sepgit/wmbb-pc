...
import Bdellcl from './bdellcl';
import Bchlcl from './bchlcl';
import Bzflcl from './bzflcl';
...
export default class Blistalllcl extends Component {
  constructor(props) {
    super(props);
          ...
          <div className="bplte">
            ...
            }
            {
              this.props.rows.RTMi != null&&this.props.rows.RTMi != 0 ?
                <div className="bpltediv">{this.props.rows.RTMi}/RT</div>:undefined
            }
          </div>
        </div>
        <div className="bplt3">
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.props.shows.texthp&&this.props.shows.keyshp==this.props.keys?
              <Bdellcl handchshow={this.handchshow}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.isch&&this.state.keysd==this.props.keys?
              <Bchlcl handchclose={this.handchclose}
                      actions={this.props.actions}
                      cabrnew={this.props.cabrnew}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.iszf&&this.state.keysd==this.props.keys?
              <Bzflcl handzfclose={this.handzfclose}
                      text={this.props.text}
