...
import Ckmid from './../../components/cabsck/ckmid';
...
class Blacklist extends Component {
  render() {
    const { actions,text,cabsck,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="blacklistpage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Ckmid actions={actions} text={text} cabsck={cabsck} />
      </div>
    );
  }
}
