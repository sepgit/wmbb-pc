/*
 * @Author: sepgit 
 * @Date: 2018-07-26 14:22:53 
 * @Last Modified by: sepgit
 * @Last Modified time: 2018-07-30 13:10:57
 */ 
...
export default class Copyfcl extends Component {
  constructor(props) {
    super(props);
    ...
    this.copyCabFCL = this.copyCabFCL.bind(this);
    this.state = {
      ...
      NOR40: this.props.cabmynew.cabDispdetail.NOR40,
      NOR40Fee: this.props.cabmynew.cabDispdetail.NOR40Fee,
      NOR40Cos: this.props.cabmynew.cabDispdetail.NOR40Cos,
  ...
  handfb() {
    ...
    let NOR40 =this.props.cabmynew.cabDispdetail.NOR40!= this.state.NOR40 ? this.state.NOR40:this.props.cabmynew.cabDispdetail.NOR40;
    let NOR40Fee =this.props.cabmynew.cabDispdetail.NOR40Fee!= this.state.NOR40Fee ? this.state.NOR40Fee:this.props.cabmynew.cabDispdetail.NOR40Fee;
    let NOR40Cos =this.props.cabmynew.cabDispdetail.NOR40Cos!= this.state.NOR40Cos ? this.state.NOR40Cos:this.props.cabmynew.cabDispdetail.NOR40Cos;
    ...
    let GP20TF, GP40TF, HQ40TF, HQ45TF, NOR40TF;
    ...
    if (carr == "") {
      ...
      // console.log(this.props.cabmynew.cabDispdetail.label);
