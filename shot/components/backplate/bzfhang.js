...
export default class Bzfhang extends Component {
    constructor(props) {
        super(props);
    ...
    handlesend(){
        ...
        let cabFee=num["20GP"]*GP20+num["40GP"]*GP40+num["40HQ"]*HQ40+num["45HQ"]*HQ45;
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.gethpxaddhang(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,GP20,GP20Wate,GP40,HQ40,HQ45,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
    ...
    render() {
        ...
        if(this.state.ptgys=='1'){
            cabFee=num["20GP"]*this.state.GP20+num["40GP"]*this.state.GP40+num["40HQ"]*this.state.HQ40+num["45HQ"]*this.state.HQ45;
        }else{
            cabFee=0;
        }
        return (
                    ...
                    <div className="xnew2">
                        ...
                        <div className="xnew4">
                            <ul>
                                ...
                                <li className="xnew15">
                                    <span className="xspan5">45HQ</span>
