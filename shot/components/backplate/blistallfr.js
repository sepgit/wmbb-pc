...
import Bdelfr from './bdelfr';
import Bchfr from './bchfr';
import Bzffr from './bzffr';
...
export default class Blistallfr extends Component {
  constructor(props) {
    super(props);
      ...
      <li className="bplt">
        ...
        <div className="bplt2">
          ...
          <div className="bplte">
            ...
            {
              this.props.rows.FR20 != null&&this.props.rows.FR20 != 0 ?
                <div className="bplte1">
                  <span>{this.props.rows.FR20}</span>
                  <img src={require('../../src/image/20fr.png')}/>
                </div>:undefined
            }
            {
              this.props.rows.FR40 != null&&this.props.rows.FR40 != 0 ?
                <div className="bplte2">
                  <span>{this.props.rows.FR40}</span>
                  <img src={require('../../src/image/40fr.png')}/>
                </div>:undefined
            }
          </div>
        </div>
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.props.shows.texthp&&this.props.shows.keyshp==this.props.keys?
              <Bdelfr handchshow={this.handchshow}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.isch&&this.state.keysd==this.props.keys?
              <Bchfr handchclose={this.handchclose}
                     actions={this.props.actions}
        ...
        <VelocityTransitionGroup enter={{animation: "fadeIn",duration:1000}} leave={{animation: "fadeOut"}}>
          {
            this.state.iszf&&this.state.keysd==this.props.keys?
              <Bzffr handzfclose={this.handzfclose}
                     text={this.props.text}
