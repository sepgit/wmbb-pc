...
export default class Xzfair extends Component {
    constructor(props) {
        super(props);
    ...
    handlesend(){
        ...
        if(depaPort==''||destPort==''){
            ...
            this.props.actions.getxaddair(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,packType,wate,bulk,itemName,expiDate,enquMemo);
