...
export default class Bzfroro extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            item:this.props.bck.enqudx.item,
    ...
    handlesend(){
        ...
        if(depaPort==''||destPort==''||leng==''||widt==''||high==''||wate==''){
            ...
            this.props.actions.getxaddhproro(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,tranship,item,leng,widt,high,itemName,expiDate,enquMemo,wate);
