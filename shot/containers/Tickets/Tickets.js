...
import TicketsMid from './../../components/tickets/tickets';
import {
  getyg,
  getqx,
  gethgerxx,
...
class cabMy extends Component {
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabrnew,cabmynew,cabnew,tktnew} = this.props;
    return (
      <div className="cabpage">
        ...
        />
        <TicketsMid actions={actions} text={text} tktnew={tktnew}/>
      </div>
    );
  }
}
