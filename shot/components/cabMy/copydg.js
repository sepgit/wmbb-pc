...
export default class Copydg extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      checked: false,
      clas: this.props.cabmynew.cabDispdetail.clas,
      unno: this.props.cabmynew.cabDispdetail.unno,
    }
  }
  ...
  handfb() {
    ...
    let unno = this.props.cabmynew.cabDispdetail.unno!= this.state.unno ? this.state.unno:this.props.cabmynew.cabDispdetail.unno;
    let clas = this.props.cabmynew.cabDispdetail.clas!= this.state.clas ? this.state.clas:this.props.cabmynew.cabDispdetail.clas;
