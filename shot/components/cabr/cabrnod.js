...
export default class Cabrnod extends Component {
    constructor(props) {
        super(props);
    ...
    hanqryi() {
        ...
        //不确认对方履约
        this.props.actions.getqrdflvr(this.state.userName,this.state.token,this.props.cabRepl,2,yi,this.props.cabEnqu);
        this.props.handnoc();
    }
    render() {
        return (
