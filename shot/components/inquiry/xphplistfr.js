...
export default class Xphplistsfr extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    let FR20,FR40,strFR20,strFR40;
    if(this.props.rows.FR20!=null&&this.props.rows.FR20!=0){
      FR20=this.props.rows.FR20;
      strFR20='20FR';
    }
    if(this.props.rows.FR40!=null&&this.props.rows.FR40!=0){
      FR40=this.props.rows.FR40;
      strFR40='40FR';
    }
    let styl='';
