...
import Meetmid from './../../components/meeting/mmid';
...
class Meeting extends Component {
  render() {
    const { actions,text,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,meets,cabnew,cabmynew} = this.props;
    return (
      <div className="meetpage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Meetmid actions={actions} text={text} meets={meets}/>
      </div>
    );
  }
}
...
Meeting=connect(mapStateToProps,mapDispatchToProps)(Meeting);
