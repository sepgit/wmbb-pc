...
export default class Bzfbb extends Component {
    constructor(props) {
        super(props);
    ...
    handlesend(){
        ...
        if(depaPort==''||destPort==''||leng==''||widt==''||high==''||wate==''){
            ...
            this.props.actions.getxaddhpbb(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,tranship,item,leng,widt,high,itemName,expiDate,enquMemo,wate);
