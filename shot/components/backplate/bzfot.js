...
export default class Bzfot extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            OT20:this.props.bck.enqudx.FR20,
            OT20Wate:this.props.bck.enqudx.FR20Wate,
            OT40:this.props.bck.enqudx.FR40,
            OT40Wate:this.props.bck.enqudx.FR40Wate,
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.getxaddhpot(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,OT20,OT20Wate,OT40,OT40Wate,leng,widt,high,itemName,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
