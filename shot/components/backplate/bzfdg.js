...
export default class Bzfdg extends Component {
    constructor(props) {
        super(props);
        ...
        this.state={
            ...
            clas:this.props.bck.enqudx.clas,
            unno:this.props.bck.enqudx.unno,
        ...
        if(depaPort==''||destPort==''){
            ...
            if(isbh){
                if(depo==undefined||enquTar==''||replTar==''||cabServ==undefined){
                    ...
                    this.props.actions.getxaddhpdg(userid,userName,token,serv,depaPort,destPort,sendTo,ccto,mngr,match,compDate,carrs,tranship,GP20,GP20Wate,GP40,HQ40,clas,unno,itemName,expiDate,enquMemo,isbh,depo,cabFee,enquTar,replTar,provType,cabServ,cabProv,cabEnqu,curr);
