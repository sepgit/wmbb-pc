 ...
 * @Last Modified time: 2018-08-03 10:04:20
 */
...
export default class Gettkts extends Component {
  constructor(props) {
    super(props);
            ...
            this.props.tktnew.tktLists.map( (s) => {
              return <li  className="lists-li clearfix" key={s.prebatch}>
                ...
                <div className="lists-li-btn clearfix">
                  ...
                  <span className="btn-get" onClick={this.getClick} data={s.prebatch}>领取</span>
                </div>
              </li>
            }):undefined
          }
