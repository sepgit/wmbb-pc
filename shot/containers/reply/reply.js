...
import Rmid from './../../components/reply/rmid';
...
class Reply extends Component {
  render() {
    const { actions,text,replays,shows,getdetil,getnewlist,zxinfo,rsup,pays,ysrdu,yssfw,yssp,cabnew,cabmynew} = this.props;
    return (
      <div className="replypage">
          ...
          <NewL actions={actions}
                ...
                cabmynew={cabmynew}
          />
          <Rmid actions={actions} text={text} replays={replays} shows={shows}/>
      </div>
    );
  }
}
...
function mapDispatchToProps(dispatch){
  return {
    actions:bindActionCreators({
      ...
      gethfjtfw:gethfjtfw,
      gethflist:gethflist,
      gethflistc:gethflistc,
      gethflistgd:gethflistgd,
      hfshow:hfshow,
...
Reply=connect(mapStateToProps,mapDispatchToProps)(Reply);
