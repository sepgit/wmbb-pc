...
export default class Bchot extends Component {
  constructor(props) {
    super(props);
  ...
  handfs(){
    ...
    let freiCurr=this.state.bz20fr;
    ...
    let FR20=this.state.OT20;
    let FR40=this.state.OT40;
              ...
              <div className="bdel20">
                ...
                <ul>
                  <li>
                    ...
                    <Select
                      value={this.state.bz20fr}
                      style={{ width: 60,marginBottom:5 }}
                      className="delsel"
                      onChange={(v)=>{return this.setState({bz20fr:v,bz40fr:v})}}
                    >
                    ...
                    />
                    {this.props.bck.enqudx.FR20!=0? <i className="btcolor">*</i>:undefined}
                  </li>
                  <li>
                    <span className="bdel20sp">40OT</span>
                    <Select
                      value={this.state.bz40fr}
                      style={{ width: 60,marginBottom:5 }}
                      className="delsel"
                      onChange={(v)=>{return this.setState({bz40fr:v,bz20fr:v})}}
                    >
                      <Option key='1' value="USD">USD</Option>
                      <Option key='2' value="CNY">CNY</Option>
                    </Select>:
                    ...
                    />
                    {this.props.bck.enqudx.FR40!=0? <i className="btcolor">*</i>:undefined}
                  </li>
                </ul>
              </div>
              <div className="bdel8">
